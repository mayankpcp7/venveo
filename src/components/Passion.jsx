...
const Passion = () => {
  return (
    <>
      <img className="mt-xl-5 mt-md-2 mt-0 pt-xl-5 w-100" src={greenline} alt="greenline" />
      <section className="bg_passion py_113 mt-4">
        ...
        <p className="text-center mx-auto mw_621 fs_15 ff_maison fw-normal pt-lg-4 mb-0">
