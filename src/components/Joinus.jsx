  ...
  return (
    <>
      ...
      <section className="bg_parrot position-relative px-4 pb-5 ">
        <div className="d-flex flex-md-row flex-column bg-white intern mw_1161 mx-auto  border_blue px_65  py_65">
          ...
          <div className="d-flex flex-column">
            <h5 className="text-start ff_maison pb-4 fw-light ps-0 ps-md-3 ps-lg-0 fs_15 mw_625">
            ...
            <a
              className="text-black  ps-0 ps-md-3 ps-lg-0 ff_maison fs_15 text-decoration-none fw-semibold"
              href="#"
            >
        ...
        <div className="d-flex flex-column justify-content-center mt_n4  align-items-center">
          ...
          <p className="text-center fs_15 fw-normal lh_133 pt-4 ff_maison fw-normal mw_687 mb-0 pb-5 mx-auto">
